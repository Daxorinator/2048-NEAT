function KeyboardInputManager() {
    (this.events = {}),
        window.navigator.msPointerEnabled
            ? ((this.eventTouchstart = "MSPointerDown"), (this.eventTouchmove = "MSPointerMove"), (this.eventTouchend = "MSPointerUp"))
            : ((this.eventTouchstart = "touchstart"), (this.eventTouchmove = "touchmove"), (this.eventTouchend = "touchend")),
        this.listen();
}
...
function runApplication() {
    ...
    e.getCookieNoticeClosed()
        ? t.parentNode.removeChild(t)
        : i.addEventListener("click", function () {
            t.parentNode.removeChild(t), e.setCookieNoticeClosed(!0), void 0 !== typeof gtag && gtag("event", "closed", { event_category: "cookie-notice" });
        });
...
(Function.prototype.bind =
    ...
    (KeyboardInputManager.prototype.listen = function () {
        var e,
            t,
            i = this,
            o = { 38: 0, 39: 1, 40: 2, 37: 3, 75: 0, 76: 1, 74: 2, 72: 3, 87: 0, 68: 1, 83: 2, 65: 3 };
        ...
        n.addEventListener(
            ...
            function (o) {
                (!window.navigator.msPointerEnabled && o.touches.length > 1) ||
                    o.targetTouches.length > 1 ||
                    i.targetIsInput(o) ||
                    (window.navigator.msPointerEnabled ? ((e = o.pageX), (t = o.pageY)) : ((e = o.touches[0].clientX), (t = o.touches[0].clientY)), o.preventDefault());
            },
            { passive: !0 }
        ),
            n.addEventListener(
    ...
    (HTMLActuator.prototype.continueGame = function () {
        "undefined" != typeof gtag && gtag("event", "restart", { event_category: "game" }), this.clearMessage();
    }),
    ...
    (HTMLActuator.prototype.addTile = function (e) {
        var t = this,
            ...
            n = e.previousPosition || { x: e.x, y: e.y },
        ...
        e.value > 2048 && r.push("tile-super"),
            ...
            e.previousPosition
                ? window.requestAnimationFrame(function () {
                    (r[2] = t.positionClass({ x: e.x, y: e.y })), t.applyClasses(i, r);
                })
                : e.mergedFrom
                    ? (r.push("tile-merged"),
                        this.applyClasses(i, r),
    ...
    (HTMLActuator.prototype.message = function (e) {
        ...
        "undefined" != typeof gtag && gtag("event", "end", { event_category: "game", event_label: t, value: this.score }), this.messageContainer.classList.add(t), (this.messageContainer.getElementsByTagName("p")[0].textContent = i);
    }),
    (HTMLActuator.prototype.clearMessage = function () {
        this.messageContainer.classList.remove("game-won"), this.messageContainer.classList.remove("game-over");
    }),
    (Grid.prototype.empty = function () {
        for (var e = [], t = 0; t < this.size; t++) for (var i = (e[t] = []), o = 0; o < this.size; o++) i.push(null);
        return e;
    }),
    ...
    (Grid.prototype.serialize = function () {
        for (var e = [], t = 0; t < this.size; t++) for (var i = (e[t] = []), o = 0; o < this.size; o++) i.push(this.cells[t][o] ? this.cells[t][o].serialize() : null);
        return { size: this.size, cells: e };
    }),
    ...
    (GameManager.prototype.setup = function () {
        ...
        e
            ? ((this.grid = new Grid(e.grid.size, e.grid.cells)), (this.score = e.score), (this.over = e.over), (this.won = e.won), (this.keepPlaying = e.keepPlaying))
            : ((this.grid = new Grid(this.size)), (this.score = 0), (this.over = !1), (this.won = !1), (this.keepPlaying = !1), this.addStartTiles()),
            this.actuate();
    }),
            ...
            this.prepareTiles(),
                a.x.forEach(function (e) {
                    a.y.forEach(function (a) {
                        if (((i = { x: e, y: a }), (o = t.grid.cellContent(i)))) {
    ...
    (GameManager.prototype.tileMatchesAvailable = function () {
        for (var e, t = 0; t < this.size; t++)
            for (var i = 0; i < this.size; i++)
                if ((e = this.grid.cellContent({ x: t, y: i })))
                    for (var o = 0; o < 4; o++) {
